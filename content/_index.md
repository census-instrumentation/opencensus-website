...
Supported backends include Azure Monitor, Datadog, Instana, Jaeger, SignalFX, Stackdriver, Zipkin, and New Relic. You can also [add support for other backends](/guides/exporters/custom-exporter/).
