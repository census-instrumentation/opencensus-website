...
MessageEvent|Yes|Yes|Yes|Yes|Yes|Yes|Yes
Start/End Time|Yes|Yes|Yes|Yes|Yes|Yes|Yes
SpanData (for exporting)|Yes|Yes|Yes|Yes|Yes|Yes|Yes
...
Create a span from current context|Yes|Yes|Yes|Yes|Yes|Yes|Yes
...
---|---|---|---|---|---|---|---
<b>Core Data Models</b>|||||||
Tag|Yes|Yes|Yes|Yes|Yes|Yes|Yes
...
TagMetadata|Yes|<span style="color: #6bb1e0">In Progress</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|<span style="color: #6bb1e0">In Progress</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
<b>Basic Operations</b>|||||||
Validate TagKey and TagValue|Yes|Yes|Yes|Yes|Yes|Yes|Yes
Insert a list of Tags into current context|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|Yes|Yes|Yes
Get Tags from current context|Yes|Yes|Yes|Yes|Yes|Yes|Yes
...
Text Format (W3C)|<span style="color: #6bb1e0">In Progress</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|<span style="color: #6bb1e0">In Progress</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|Yes
...
---|---|---|---|---|---|---|---
<b>Core Data Models</b>|||||||
Measure (Int64 and Double)|Yes|Yes|Yes|Yes|Yes|Yes|Yes
Measurement (Int64 and Double)|Yes|Yes|Yes|Yes|Yes|Yes|Yes
MeasureMap or equivalent (allow for batch recording)|Yes|Yes|Yes|Yes|Yes|Yes|Yes
Aggregation (Count, Sum, LastValue, Distribution)|Yes|Yes|Yes|Yes|Yes|Yes|Yes
Bucket Boundaries (only with postive bounds)|Yes|Yes|Yes|Yes|Yes|Yes|Yes
AggregationData (Count, Sum, LastValue, Distribution)|Yes|Yes|Yes|Yes|Yes|Yes|Yes
View|Yes|Yes|Yes|Yes|Yes|Yes|Yes
ViewData|Yes|Yes|Yes|Yes|Yes|Yes|Yes
<b>Basic Operations</b>|||||||
Create Int64 or Double Measurements|Yes|Yes|Yes|Yes|Yes|Yes|Yes
...
Record against implicit (current) context|Yes|Yes|Yes|Yes|Yes|Yes|Yes
...
---|---|---|---|---|---|---|---
<b>Core Data Models</b>|||||||
LabelKey|Yes|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
...
Derived Gauge|Yes|Yes|<span style="color: #CF7675">No</span>|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
Cumulative|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
...
---|---|---|---|---|---|---|---
<b>Metrics</b>|||||||
Stackdriver Monitoring|Yes|Yes<span style="color: #CF7675"> (using ViewData)</span>|<span style="color: #CF7675">No</span>|Yes<span style="color: #CF7675"> (using ViewData)</span>|Yes|Yes<span style="color: #6bb1e0"> (using Go Daemon)</span>|<span style="color: #CF7675">No</span>
Prometheus|Yes|Yes<span style="color: #CF7675"> (using ViewData)</span>|Yes<span style="color: #CF7675"> (using ViewData)</span>|Yes<span style="color: #CF7675"> (using ViewData)</span>|Yes<span style="color: #CF7675"> (using ViewData)</span>|Yes<span style="color: #6bb1e0"> (using Go Daemon)</span>|Yes
<b>Tracing</b>|||||||
