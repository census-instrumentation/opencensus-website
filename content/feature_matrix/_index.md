...
Attributes Double/Float64|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|Yes
...
<b>Propagation</b>|
Binary Format - gRPC|Yes|Yes|Yes|Yes|<span style="color: #6bb1e0">Client only</span>|Yes
...
<b>Stats Plug-in</b>|
gRPC plug-in for Metrics|Yes|Yes<span style="color: #CF7675"> (missing started_rpcs metrics)</span>|<span style="color: #CF7675">No</span>|<span style="color: #6bb1e0">In Progress</span>|<span style="color: #CF7675">No</span>|Yes
...
Double and Long Gauge|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
...
Register gauges to metric registry|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>

Feature|Java|Go|Python|Nodejs|PHP|Erlang/Elixir
---|---|---|---|---|---|---
Top-level Resource API|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
Auto-detect GCE/GKE/AWS EC2 resources|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
Set resources for custom environment|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
Encode and decode resource|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
Merge mutiple resources|Yes|Yes|Yes|Yes|<span style="color: #CF7675">No</span>|<span style="color: #CF7675">No</span>
...
---|---|---|---|---|---|---
<b>Metrics</b>|
Stackdriver Monitoring|Yes|Yes|Yes<span style="color: #CF7675"> (using ViewData)</span>|Yes|Yes<span style="color: #6bb1e0"> (using Go Daemon)</span>|<span style="color: #CF7675">No</span>
...
Zipkin|Yes|Yes|Yes|Yes|Yes|Yes
{{% /tabs %}}
